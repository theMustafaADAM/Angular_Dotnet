...
export class RegisterComponent implements OnInit {
    ...
    imageUrl: string = '../../assets/images/bg-register.webp';
    ...
    ngOnInit(): void {
        ...
        this.confirmEmail = new FormControl('', [Validators.required, this.validatorService.MustMatch(this.email)]);
        ...
        this.phone = new FormControl('', [Validators.required, Validators.pattern('^\\(?([0-9]{3})\\)?[-. ]?([0-9]{3})[-. ]?([0-9]{4})$')]);
            ...
            .subscribe(
                (result) => {
                    if (result.message == 'Registration Successful') {
                        ...
                        //             Swal.getContent().querySelector('b').textContent = String((Swal.getTimerLeft() / 1000).toFixed(0));
                        //         }, 100);
                        //     },
                        //     onClose: () => {
