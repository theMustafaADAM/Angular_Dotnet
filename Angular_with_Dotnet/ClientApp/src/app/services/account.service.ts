...
export class AccountService extends ObservableStore<StoreState> {
        ...
        if (params.get('username') !== null) {
            if (!this.profileDetails$) {
                this.profileDetails$ = this.http
                    .get<any>(this.baseUrlGetProfile + '/' + this.UserName.getValue(), {
                        params: params
                    })
                    .pipe(
                        shareReplay(),
    ...
    getUserActivity(): Observable<any> {
        ...
        if (params.get('username') !== null) {
            this.activityDetails$ = this.http.get<any>(this.baseUrlGetUserActivity + '/' + this.UserName.getValue(), { params: params }).pipe(
                map(
                    (result) => {
                        return result;
                    },
    ...
    sendTwoFactorProvider(providerType: string, rememberDevice: boolean): NewType {
